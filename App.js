        ...
        BleManager.connect(peripheral.id).then(() => {
          ...
          setTimeout(() => {
            ...
            BleManager.retrieveServices(peripheral.id).then((peripheralInfo) => {
              ...
              var service = '51BCC738-C355-4DB5-B7A6-6480BDFBF581';
              var readCharacteristic = '51BCC738-C355-4DB5-B7A6-6480BDFBF581';
              var writeCharacteristic = '51BCC738-C355-4DB5-B7A6-6480BDFBF581';
              ...
              setTimeout(() => {
                BleManager.startNotification(peripheral.id, service, readCharacteristic).then(() => {
                  ...
                  setTimeout(() => {
                    BleManager.write(peripheral.id, service, writeCharacteristic, [0]).then(() => {
